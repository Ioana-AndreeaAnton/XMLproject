...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <nav class="d-lg-flex">
                    ...
                    <ul class="menu mt-2 ml-auto">
                        ...
                        <li class=""><a href="contact.php">Contact Page</a></li>
                    </ul>
                ...
                <div class="login px-sm-4 mx-auto mw-100">
                    ...
                    <form name="form" method="post" action="login.php">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" aria-describedby="UsernameHelp" placeholder="" required="">
                            <small id="UsernameHelp" class="form-text text-muted">We'll never share your private details with anyone else.</small>
                        </div>
                        <div class="form-group">
        ...
        <div id="popupLogin" class="popup-effect">
            <div class="popup"
        </div>
        <?php
        $cookie_name = "bla_bla";
